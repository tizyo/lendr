...
function emptyWebhookSecret(string $key): void
{
...
test('flutterwave gateway: successful charge records payment', function () {
    ...
    emptyWebhookSecret('flutterwave_webhook_secret');
...
test('flutterwave gateway: wrong signature returns 401', function () {
    DB::table('settings')->updateOrInsert(['key' => 'flutterwave_webhook_secret'], ['value' => 'secret123']);
...
test('pawapay gateway: COMPLETED status records payment', function () {
    ...
    emptyWebhookSecret('pawapay_webhook_secret');
