...
class InitiateMobileMoneyPaymentJob implements ShouldQueue
{
    ...
    private function pawapay(MobileMoneyIntent $intent): void
    {
        ...
        if (! $apiKey) { $this->unsupported($intent, 'pawapay_api_key not configured'); return; }
    ...
    private function airtel(MobileMoneyIntent $intent): void
    {
        ...
        if (! $clientId || ! $clientSecret) { $this->unsupported($intent, 'Airtel credentials not configured'); return; }
    ...
    private function mtn(MobileMoneyIntent $intent): void
    {
        ...
        if (! $subscriptionKey || ! $apiUser || ! $apiKey) { $this->unsupported($intent, 'MTN credentials not configured'); return; }
    ...
    private function zamtel(MobileMoneyIntent $intent): void
    {
        ...
        if (! $apiKey || ! $baseUrl) { $this->unsupported($intent, 'Zamtel credentials not configured'); return; }
    ...
    private function lipila(MobileMoneyIntent $intent): void
    {
        ...
        if (! $apiKey || ! $baseUrl) { $this->unsupported($intent, 'Lipila credentials not configured'); return; }
