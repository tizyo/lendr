...
// Anonymous class avoids name collision with the identical root migration.
return new class extends Migration
{
    public function up(): void
    {
        ...
        // Skip if permissions tables already exist (e.g. test env running both root + tenant migrations on same DB).
